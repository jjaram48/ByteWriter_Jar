...
int numBits;
String fileName = "filename.pdf"; //give path and file name to render (keep under 30MB!!!) see "split" terminal command for MacOSX for help breaking files into managable chunks
...
imgLength = numPixel / imgWidth; //calculate image length
